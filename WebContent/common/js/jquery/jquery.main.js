...
jQuery(function(){
	initTabs();
	$(".color").find("tr").each(function(i){this.style.backgroundColor=['#e1e1e1','#f9f9f9'][i%2]})//一行为白色，一行为灰色
    ...
    $("tr:even").css("backgroundColor","#e1e1e1"); //偶数行的颜色

    $("tr:odd").css("backgroundColor","#f9f9f9");  //奇数行的颜色
	
	$(this).css("color","#1f2427");
